...
const TABLE_HEAD = ["Lastname", "Firstname", "Middlename", ""];
...
const Index = ({ auth }) => {
    ...
    const fetchAuthors = async ({ queryKey }) => {
        ...
        const response = await axios.get(`${API_URL}/api/get_author_paginate`, {
            params: {
                page,
                lastname: query,
                sortColumn,
    ...
    const [currentPage, setCurrentPage] = useState(authors?.current_page || 1);
    ...
    return (
        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-5xl sm:px-6 lg:px-5">
