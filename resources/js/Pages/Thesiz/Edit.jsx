...
const Create = ({ auth, courses, authors, thesiz }) => {
    const { data, setData, post, errors, reset, processing } = useForm({
        accession_no: thesiz.accession_no || "",
        author_id: thesiz.author_id.toString() || "",
        title: thesiz.title || "",
        year: thesiz.year || "",
        copies: thesiz.copies || "",
        date_process: thesiz.date_process || "",
        page_number: thesiz.page_number || "",
        course_id: thesiz.course_id.toString() || "",
        files: "",
        _method: "PUT",
    });

    console.log(thesiz.id);

    const onSubmit = (e) => {
        e.preventDefault();

        post(route("thesis.update", thesiz.id));
    };
